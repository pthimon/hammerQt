...
#include "../common.h"
#include "UnitConfigData.h"    // for member
#include "UnitConfigSchema.h"

class UnitConfigHandler : public XERCES_CPP_NAMESPACE_QUALIFIER ContentHandler
{
public:
	UnitConfigHandler();
	virtual ~UnitConfigHandler();
